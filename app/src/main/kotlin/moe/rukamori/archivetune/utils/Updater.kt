...
object Updater {
    ...
    private const val StableReleaseBaseUrl = "https://github.com/ElseIfVoid/ArchiveTune-Fork/releases"
    private const val CanaryReleaseBaseUrl =
        "https://github.com/ElseIfVoid/ArchiveTune-Fork/releases"
    private const val CanaryWorkflowRunsUrl =
        "https://api.github.com/repos/ElseIfVoid/ArchiveTune-Fork/actions/workflows/build.yml/runs" +
    ...
    private fun workflowArtifactDownloadUrl(): String {
        val artifactUrl =
            "https://nightly.link/ElseIfVoid/ArchiveTune-Fork/workflows/build/main/${workflowArtifactName()}"
    ...
    private suspend fun fetchReleasesNetwork(
        ...
        val response: HttpResponse =
            client.get("https://api.github.com/repos/ElseIfVoid/ArchiveTune-Fork/releases?per_page=$perPage") {
                headers {
    ...
    suspend fun getCommitHistory(
        ...
        runCatchingCancellable {
            ...
            val response =
                client
                    .get("https://api.github.com/repos/ElseIfVoid/ArchiveTune-Fork/commits?sha=$branch&per_page=$count")
                    .bodyAsText()
